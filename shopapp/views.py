...
def shop_box(request, pk):
    ...
    for shop in box_data:
        for shop2 in box_data2:
            Self_box(self_box=shop2, box_shop=shop, box_img=shop.shop_img.url, box_name=shop.shop_name, box_cash=shop.shop_cash).save()
...
def shop_list(request, pk):
    ...
    # print(shop, '1111111111111111111111111111')
    # for pk_shop in shop:
    #     shop_pk.append(pk_shop.pk)
    print(box_obj)
    context={}
